...
function setup() {
  ...
  player = new Babushka(width/2,height/2)
...
function draw() {
  ...
  background(forest,width*5,height); 

  image(forest,camera.position.x*18,height/2, width, height) 
...
function MyScore(){
  ...
  textSize(50);
  textStyle(BOLD);
  text("AKSHAY'S BABUSHKA HOTFOOT 2020",700,70);
  pop()
}
